  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
      ...
      {/* <div className="absolute top-0 right-0 -z-10 w-full h-full">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] lg:w-[800px] lg:h-[800px] bg-primary rounded-full opacity-90 translate-x-1/3 -translate-y-1/4"></div>
      </div> */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a
                href="#"
                className="inline-flex items-center justify-center px-8 py-4 bg-primary text-white rounded-lg font-semibold hover:bg-primary-600 transition-all shadow-lg hover:shadow-xl"
              >
                Aktifkan Pengingat
              </a>
